...
\begin{block}{}
These slides at \href{{https://github.com/QuantumComputingQuantumMachineLearning/MLforMaterialsScience}}{\nolinkurl{https://github.com/QuantumComputingQuantumMachineLearning/MLforMaterialsScience}}
\end{block}
\end{frame}
...
\item \href{{https://doi.org/10.48550/arXiv.2305.08831}}{Neural-network quantum states for ultra-cold Fermi gases, Jane Kim et al, Nature Physics, in press (2024)}
...
\begin{frame}[plain,fragile]
\frametitle{Classification of phases, Heisenberg model in 3D, magnetization}
...
% inline figure
\centerline{\includegraphics[width=0.9\linewidth]{figures/heisenber0.png}}
...
\begin{frame}[plain,fragile]
\frametitle{Classification of phases, Heisenberg model in 3D, susceptibility}
...
% inline figure
\centerline{\includegraphics[width=0.9\linewidth]{figures/heisenber1.png}}
...
\begin{frame}[plain,fragile]
\frametitle{Classification of phases, Heisenberg model in 3D, order}
...
% inline figure
\centerline{\includegraphics[width=0.9\linewidth]{figures/heisenber4.png}}
...
\begin{frame}[plain,fragile]
\frametitle{Classification of phases, Heisenberg model in 3D, CNNs training}
...
% inline figure
\centerline{\includegraphics[width=0.9\linewidth]{figures/heisenber2.png}}
...
\begin{frame}[plain,fragile]
\frametitle{Classification of phases, Heisenberg model in 3D, CNNs confusion matrix}
...
% inline figure
\centerline{\includegraphics[width=0.9\linewidth]{figures/heisenber3.png}}
